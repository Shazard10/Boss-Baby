...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.append([InlineKeyboardButton("〄 𝙷𝙾𝚆 𝚃𝙾 𝙶𝙴𝚃 𝙼𝙾𝚅𝙸𝙴𝚂 〄",callback_data="seriess")])
        btn.insert(0,
            [InlineKeyboardButton(f"۞ {search} ۞",callback_data="neosub")]
        )             
    else:
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('<b>✯ 𝖢𝗁𝖾𝖼𝗄 𝖮𝖳𝖳 𝖱𝖾𝗅𝖾𝖺𝗌𝖾 ᴏʀ 𝖢𝗈𝗋𝗋𝖾𝖼𝗍 𝖳𝗁𝖾 𝗌𝗉𝖾𝗅𝗅𝗂𝗇𝗀\n\n✯ 𝖣𝗈𝗇𝗍 𝖴𝗌𝖾 𝖲𝗒𝗆𝖻𝗈𝗅𝗌 𝖶𝗁𝗂𝗅𝖾 𝖱𝖾𝗊𝗎𝖾𝗌𝗍 (-:!;?) \n\n✯ [𝖬𝗈𝗏𝗂𝖾 𝖭𝖺𝗆𝖾 𝖸𝖾𝖺𝗋 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾] 𝖠𝗌𝗄 𝖳𝗁𝗂𝗌 𝖶𝖺𝗒</b>\n\n📯𝐍𝐛: 𝗜𝗳 𝗜𝘁 𝗜𝘀 𝗔 𝗥𝗲𝗹𝗲𝗮𝘀𝗲𝗱 𝗠𝗼𝘃𝗶𝗲 𝗦𝗲𝗻𝘁 𝗠𝗲𝘀𝘀𝗲𝗴𝗲 𝗧𝗼 𝗧𝗵𝗲 𝗔𝗱𝗺𝗶𝗻')
